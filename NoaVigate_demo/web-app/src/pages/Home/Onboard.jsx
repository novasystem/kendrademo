                    ...
                    actions={
                        ...
                        <SpaceBetween direction="vertical" size="m" >
                            <Typography style={{marginRight: "100px"}}>Upload documents into S3 for ingestion into a Kendra Index.  
                                Click on Sync Now to start the document ingestion process, sync time varies based on the number of documents updated. Document types supported: 
                            ...
                            <SpaceBetween direction="horizontal" size="l" ><br/>
                                ...
                                <Typography>Follow these steps to configure role based access:
                                    <ul>
                                        <li>
                                            Modify <Button iconName="edit" variant="inline-icon" onClick={onModifyAcl}> Modify ACL</Button> the permissions configuration file on the S3 bucket.
                                            
                                        </li>
                                
                                        <li>
                                            After modifications, click on Sync Now button to start the document ingestion process and also for permissions to take effect.
                                        </li>
                                    </ul>
                                </Typography>
        ...
        <SpaceBetween direction="vertical" size="s">
            <Container >
                ...
                <SpaceBetween direction="horizontal" size="xxl">
                    ...
                    />
                <Box float="right">
                    <Button variant="outlined" iconName="add-plus" onClick={showDocumentModel}>Upload</Button>
                </Box>
                {
                    showPickFilesMsg &&
                    <Alert  
