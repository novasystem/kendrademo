...
export class AppStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: AppStackProps) {
    ...
    const kendraACL = [
      {
          "keyPrefix":`s3://${kendraInputBucket.bucketName}/public/Andalucia/`,
          "aclEntries": [
              {
                  "Name": "Andalucia",
                  "Type": "GROUP",
      ...
      {
          "keyPrefix": `s3://${kendraInputBucket.bucketName}/public/Cataluna/`,
          "aclEntries": [
              {
                  "Name": "Cataluna",
                  "Type": "GROUP",
      ...
      {
          "keyPrefix": `s3://${kendraInputBucket.bucketName}/public/ComunidadDeMadrid/`,
          "aclEntries": [
              {
      ...
      {
          "keyPrefix": `s3://${kendraInputBucket.bucketName}/public/ComunidadValenciana/`,
          "aclEntries": [
              {
      ...
      {
          "keyPrefix": `s3://${kendraInputBucket.bucketName}/public/Espana/`,
          "aclEntries": [
            {
                  "Name": "ComunidadDeMadrid",
                  "Type": "GROUP",
  ...
  private createDocumentsTable(){
    ...
    // Create an output for the DynamoDB table name
    new cdk.CfnOutput(this, 'DocumentsArtifactsTableName', {
      value: this.documentsArtifactsTable.tableName,
      description: 'DynamoDB table name for DocumentArtifacts',
    });
  }
